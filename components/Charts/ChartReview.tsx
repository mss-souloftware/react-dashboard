...
const ChartReview: React.FC = () => {
  const [state, setState] = useState<ChartReviewState>({
    series: [
      {
        name: "Response",
    ...
    <div className="col-span-12 rounded-lg bg-black p-7.5 shadow-default xl:col-span-4">
      ...
      <div className="grid grid-cols-2 gap-4 justify-between mb-5">
        <div className="w-6/12 rounded-lg shadow-default">
          ...
          <div className="flex">
            <h4 className="text-xl font-bold text-white">2,400</h4> <span className="text-danger text-xs ml-2 mt-2">(&darr;13%)</span>
          </div>
        </div>
        <div className="w-6/12 rounded-lg shadow-default">
          <p className="text-sm mb-3">Scores</p>
          <div className="flex">
            <h4 className="text-xl font-bold text-white">15.4%</h4> <span className="text-danger text-xs ml-2 mt-2">(&darr;8%)</span>
          </div>
        </div>
      </div>
      <div>
        <div id="chartReview" className="-ml-5 -mb-9">
          <ApexCharts
            options={options}
            series={state.series}
            type="bar"
